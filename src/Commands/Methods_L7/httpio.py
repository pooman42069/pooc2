...
def httpio(args, validate_time, send, client, ansi_clear, broadcast, data):
    ...
    if len(args) == 5:
        ...
        xxxx = '''%s============= (%sTARGET%s) ==============
            ...
            %sTYPE:%s %s
         %sTHREADS:%s %s
          %sMETHOD:%s %s'''%(Fore.LIGHTBLACK_EX, Fore.GREEN, Fore.LIGHTBLACK_EX, Fore.MAGENTA, Fore.LIGHTWHITE_EX, url, Fore.MAGENTA, Fore.LIGHTWHITE_EX, secs, Fore.MAGENTA, Fore.LIGHTWHITE_EX, attackType, Fore.MAGENTA, Fore.LIGHTWHITE_EX, threadx, Fore.MAGENTA, Fore.LIGHTWHITE_EX, 'HTTP IO')
