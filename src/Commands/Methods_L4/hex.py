...
def hex(args, validate_ip, validate_port, validate_time, send, client, ansi_clear, broadcast, data):
    if len(args) == 4:
        ...
        xxxx = '''%s============= (%sTARGET%s) ==============
            ...
            %sPORT:%s %s
            %sTIME:%s %s
          %sMETHOD:%s %s'''%(Fore.LIGHTBLACK_EX, Fore.GREEN, Fore.LIGHTBLACK_EX, Fore.MAGENTA, Fore.LIGHTWHITE_EX, ip, Fore.MAGENTA, Fore.LIGHTWHITE_EX, port, Fore.MAGENTA, Fore.LIGHTWHITE_EX, secs,Fore.MAGENTA, Fore.LIGHTWHITE_EX, 'HEXIDECIMAL Flood')
